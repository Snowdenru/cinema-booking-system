...
from .models import Booking, Movie, Genre
...
class BookingForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Динамически создаем выбор мест
        seats = []
        for row in range(1, 6):  # 5 рядов (A-E)
...
class MovieFilterForm(forms.Form):
    SORT_CHOICES = [
        ('-retease_date', 'По дате выхода (новые)'),
